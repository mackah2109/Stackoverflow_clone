        ...
        <form>
          ...
          </label>
          {
            isSignup && (
              ...
              <label htmlFor='check'>
                <input type='checkbox' id='check' style={{height:'15px',marginTop:'18px'}}/>
          ...
          {
            isSignup && (
              <p style={{color:'#666757', fontSize:'13px'}}>By clicking “Sign up”, you agree to our <span style={{color:'#007ac6'}} >terms of <br/>service</span> and acknowledge that you
               have read and <br/>understand our <span style={{color:'#007ac6'}}>privacy policy</span> and <span style={{color:'#007ac6'}}> code of <br/>conduct.</span></p>
            )
          }
